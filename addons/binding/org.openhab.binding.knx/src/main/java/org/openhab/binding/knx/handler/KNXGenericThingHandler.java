...
public class KNXGenericThingHandler extends BaseThingHandler
    ...
    protected Logger logger = LoggerFactory.getLogger(KNXGenericThingHandler.class);
    ...
    private static long POLLING_INTERVAL = 60000;
    private static long OPERATION_TIMEOUT = 5000;
    private static long OPERATION_INTERVAL = 2000;
    ...
    public void initialize() {
        ...
        try {
            ...
            logger.error("An exception occurred while setting the individual address '{}' : '{}'",
                    getConfig().get(ADDRESS), e.getMessage());
        }
        ...
        public void run() {
            try {
                ...
                logger.debug(
                        ...
                        new Object[] { address, dpt, getThing().getUID(), e });
            }
        }
    };
