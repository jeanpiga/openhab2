...
public class KNXChannelSelectorProxy {
    ...
    public enum KNXChannelSelector {
        ...
        private KNXChannelSelector(String channelID) {
        ...
        public static KNXChannelSelector getValueSelectorFromChannelTypeId(String valueSelectorText)
            ...
            throw new IllegalArgumentException(valueSelectorText + " is not a valid value selector");
        }
